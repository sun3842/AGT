<div class="card">
    <div class="card-body">
        <h1 class="card-title heading"><?php echo $this->lang->line('admin_account_information')?></h1>
        <!--        <p class="card-description">-->
        <!--            Basic form elements-->
        <!--        </p>-->
        <h5 class="sub-heading"><?php echo $this->lang->line('admin_personal_information')?></h5>
        <form class="forms-sample" method="post" name="update_admin_info" id="update_admin_info"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="first_name" placeholder="<?php echo $this->lang->line('first_name')?>"
                       value="<?php echo $user_info['admin_user_first_name'] ?>" readonly>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="last_name" placeholder="<?php echo $this->lang->line('last_name')?>"
                       value="<?php echo $user_info['admin_user_last_name'] ?>" readonly>
            </div>
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="user_email" id="user_email" placeholder="<?php echo $this->lang->line('user_email')?>"
                       value="<?php echo $user_info['admin_user_email_address'] ?>" required readonly>
            </div>
            <div class="form-group">
            ...
            <div class="user_login_info">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="user_name" name="user_name" placeholder="<?php echo $this->lang->line('user_name')?>"
                           value="<?php echo $user_info['admin_user_name'] ?>">
                </div>
                <div class="form-group">
                ...
                <input type="hidden" name="admin_user_id" id="admin_user_id" value="<?php echo $user_info['admin_user_id']?>">
            </div>
            <div style="text-align: center">
                <button type="submit" class="btn btn-primary mr-2" style="font-size: x-large"><?php echo $this->lang->line('update')?></button>
                <?php if($user_info['admin_user_active']==1){?>
                    <a  href="<?php echo base_url('de_active_admin_user/'.$user_info['admin_user_id'])?>" class="btn btn-warning mr-2" style="font-size: x-large"><?php echo $this->lang->line('de_active')?></a>
                <?php } else if($user_info['admin_user_active']==0){?>
                    <a  href="<?php echo base_url('active_admin_user/'.$user_info['admin_user_id'])?>" class="btn btn-success mr-2" style="font-size: x-large"><?php echo $this->lang->line('active')?></a>
                <?php }?>
                <a  href="<?php echo base_url('remove_admin_user/'.$user_info['admin_user_id'])?>" class="btn btn-danger mr-2 deletebutton" style="font-size: x-large"><?php echo $this->lang->line('remove')?></a>
            </div>
        </form>
    </div>
</div>
