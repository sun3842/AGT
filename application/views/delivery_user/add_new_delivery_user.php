<div class="card">
    <div class="card-body">
        <h1 class="card-title heading"><?php echo $this->lang->line('create_new_delivery_user')?></h1>
        <!--        <p class="card-description">-->
        <!--            Basic form elements-->
        <!--        </p>-->
        <h5 class="sub-heading"><?php echo $this->lang->line('user_personal_information')?></h5>
        <form class="forms-sample" method="post" name="add_delivery_user_info" id="add_delivery_user_info" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="user_identity_number" id="user_identity_number"
                       placeholder="<?php echo $this->lang->line('user_identity_number')?>">
            </div>
<!--            <div class="form-group">-->
...
<!--            </div>-->
            ...
            <div class="user_login_info">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="user_name" id="user_name" placeholder="<?php echo $this->lang->line('user_name')?>">
                </div>
                <div class="form-group">
